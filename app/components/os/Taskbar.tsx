        ...
        <div className='flex-1 flex items-center justify-center'>
          ...
          >
            <svg viewBox='0 0 100 100' className='w-6 h-6 text-[#0078d4]'>
              <path
                fill='currentColor'
                d='M4 4h44v44H4zM52 4h44v44H52zM4 52h44v44H4zM52 52h44v44H52z'
              />
            </svg>
          </button>
...
const TaskbarIcon = ({
  ...
  return (
    <motion.button
      ...
      `}
    >
      <div className='w-6 h-6 flex items-center justify-center'>{w.icon}</div>
      {/* Active Indicator */}
      <div
        className={`absolute bottom-0 left-1/2 -translate-x-1/2 h-1 rounded-t-full transition-all
